        ...
        <div id="overview" class="content-section">
            ...
            <div class="stats">
                ...
                <div class="stat-card">
                    ...
                    <p id="total-users"><?= htmlspecialchars($totalEmployeeCount); ?></p>
    ...
    <aside class="sidebar" role="navigation" aria-label="Main Navigation">
        <nav class="sidebar-nav">
            <ul>
                ...
                <li>
                    <a href="javascript:void(0)" onclick="toggleDropdown('employeeManagement')" role="button" aria-expanded="false" aria-controls="employeeManagement"><i class='bx bxs-user'></i> Employee Management</a>
                    <ul id="employeeManagement" class="dropdown" aria-hidden="true">
                        <li><a href="add_employee.php" role="link">Add Employee</a></li>
                        <li><a href="allemployee.php" role="link">All Employees</a></li>
                        <li><a href="bin.php" role="link">Manage Employees</a></li>
                    </ul>
                </li>
                <li>
